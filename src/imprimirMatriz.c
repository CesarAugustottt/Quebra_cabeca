...
//imprimir matriz função
void imprimirMatriz(Jogo *tabuleiro) {
    ...
    printf(BLUE(TAB_TL));
    for (int i = 0; i < m - 1; i++) {
        printf(BLUE(TAB_HOR TAB_HOR TAB_HOR TAB_TJ));
    }
    printf(BLUE(TAB_HOR TAB_HOR TAB_HOR TAB_TR "\n"));
    ...
    for (int i = 0; i < m; i++) {
        ...
        if (i < m - 1) {
            printf(BLUE(TAB_ML));
            for (int j = 0; j < m - 1; j++) {
                printf(BLUE(TAB_HOR TAB_HOR TAB_HOR TAB_MJ));
            }
            printf(BLUE(TAB_HOR TAB_HOR TAB_HOR TAB_MR "\n"));
        }
    }
    ...
    printf(BLUE(TAB_BL));
    for (int i = 0; i < m - 1; i++) {
        printf(BLUE(TAB_HOR TAB_HOR TAB_HOR TAB_BJ));
    }
    printf(BLUE(TAB_HOR TAB_HOR TAB_HOR TAB_BR "\n"));
}
